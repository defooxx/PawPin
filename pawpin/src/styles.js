...
.pp-role-choice { align-items: center; background: var(--bg); border: 1px solid var(--line); border-radius: 14px; color: var(--ink-soft); cursor: pointer; display: flex; flex-direction: column; font-size: 10px; font-weight: 700; gap: 5px; padding: 10px 4px; }
...
.pp-password-checks span { align-items: center; background: var(--bg); border-radius: 999px; color: var(--ink-soft); display: flex; font-size: 10px; font-weight: 700; gap: 3px; padding: 4px 7px; }
...
.pp-upload { align-items: center; background: var(--sage-soft); border: 1px dashed var(--sage); border-radius: 14px; color: var(--sage); cursor: pointer; display: flex; font-size: 12px; font-weight: 700; gap: 8px; justify-content: center; margin: 12px 0; padding: 13px; }
.pp-auth-flow { display: flex; flex-direction: column; justify-content: flex-start; min-height: 610px; padding: 116px 8px 28px; }
...
.pp-auth-roles .pp-role-choice { border-radius: 16px; font-size: 12px; gap: 7px; min-height: 74px; }
